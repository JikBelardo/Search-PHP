...
<body>
	...
	<div class="container" style="border-style: solid; border-color: red; background-color: #ffcbd1;height: 500px;">
		...
		<h2>Email: <?php echo $getUserByID['age']; ?></h2>
		<h2>Gender: <?php echo $getUserByID['civil_status']; ?></h2>
		<h2>Address: <?php echo $getUserByID['date_added']; ?></h2>
		<h2>State: <?php echo $getUserByID['camera_type']; ?></h2>
		<h2>Nationality: <?php echo $getUserByID['years_of_experience']; ?></h2>
		<h2>Car Brand: <?php echo $getUserByID['specialized_event']; ?></h2>
